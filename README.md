...
Images required by pages within the beta.kent site & pattern libraries are stored in a `media` directory beta.kent shared folder on the www-test & www-live servers.

## Setup

This repository needs the https://github.com/unikent/kent-theme repository to be set up. Please refer to that repository's readme for instructions.
